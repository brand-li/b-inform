...
class WPNotif_Gateway
{
    ...
    public function custom_gateway_option($smsgateways)
    {
        ...
        $desc = '<i>' . __('Enter gateway attributes separated by "," and values by ":"') . '</i><br />';
        ...
        $custom = array(
            'custom_gateway' => array(
                ...
                'inputs' => array(
                    ...
                    __('Gateway Attributes') => array('textarea' => true, 'name' => 'gateway_attributes', 'rows' => 3, 'desc' => $desc, 'placeholder' => $placeholder),
